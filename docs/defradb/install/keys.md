...
Used for [access control](/security/identity.md) and signatures.
...
The databases creates keys automatically on startup if they are not found, but you can also generate or import keys manually:
