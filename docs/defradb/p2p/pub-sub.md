...
To ensure that private documents stay private in P2P networks, either deploy the same [Document Access Control policies](/security/document-access-control.md) across all network peers, or host your policies on SourceHub.
